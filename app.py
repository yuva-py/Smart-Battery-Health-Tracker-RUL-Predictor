...
import time
from model import run_enhanced_analysis  
import os
...
<style>
    ...
    .status-healthy { border-left-color: 
    .status-warning { border-left-color: 
    .status-critical { border-left-color: 
    .sidebar-section {
        background: 
        padding: 1rem;
        border-radius: 8px;
